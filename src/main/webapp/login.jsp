        ...
        <div class="col-5" style="margin: auto; margin-top: 200px;">
            ...
            <form action="login">
                ...
                <div class="LogInBtn container text-center my-4">
                    <input type="button" name="Submit" value="Log In" class="rounded-3" style="background-color: #F7B942; text-decoration: none; border: none; outline: none; height: 40px; width: 80px">
                </div>
            </form>
        </div>
    </body>